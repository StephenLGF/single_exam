...
public class WrongQuizVo {
    ...
    public List<Integer> getwAnswer() {
        return wAnswer;
    }

    public void setwAnswer(List<Integer> wAnswer) {
    ...
    public void setwAnswer(String wAnswer) {
        List<Integer> result = new ArrayList<>();
        String[] wAnswerArray = wAnswer.split(",");
        for (String answerStr : wAnswerArray) {
            result.add(Integer.parseInt(answerStr));
        }
        this.wAnswer = result;
    }
